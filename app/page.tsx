...
export default function Home() {
	...
	const { loading, image, imageUpload, breedPredictions } = useIdentifier();

	return (
		<main className='h-screen overflow-hidden flex flex-col pt-36 md:pt-0 md:justify-center items-center bg-gray-100 selection:bg-slate-300/30'>
			<section className='flex flex-col gap-8 md:gap-16 items-center'>
				...
				<ImageUploader onImageUpload={imageUpload} setFileName={setFileName} />
			...
			<Predictions predictions={breedPredictions} loading={loading} />
			</section>
		</main>
	);
}
